...
contract Bridge is Pausable, AccessControl, SafeMath {
    ...
    enum VaultProposalStatus {Inactive, Active, Passed, Executed, Cancelled}
    ...
    /**
     *  @notice Returns a vaultProposal.
        @param originChainID Chain ID deposit originated from.
        @param depositNonce ID of proposal generated by proposal's origin Bridge contract.
        @param dataHash Hash of data to be provided when deposit proposal is executed.
        @return VaultProposal which consists of:
     */
    function getVaultProposal(uint8 originChainID, uint64 depositNonce, bytes32 dataHash) external view returns (VaultProposal memory) {
        uint72 nonceAndID = (uint72(depositNonce) << 8) | uint72(originChainID);
        return _vaultProposals[nonceAndID][dataHash];
    }
